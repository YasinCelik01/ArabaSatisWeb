<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="anasayfa.aspx.cs" Inherits="ArabaSatisWeb.Pages.anasayfa" %>
...
<div class="cars-container">
    ...
    <script>
            ...
            .then(data => {
                ...
                if (data && data.Data) {
                    data.Data.forEach(car => {
                        ...
                        <button onclick="FavoriCar(${car.ArabaId})" class="btn btn-Favori">Favorilere ekle</button>
        ...
        function FavoriCar(carId) {
            fetch('/api/araba/favorilereEkle', {
                method: 'POST',
                headers: {
                ...
                .then(data => {
                    if (data && data.Message === "Araba favorilere başarıyla eklendi.") {
                ...
                .catch(error => {
                    console.error('Hata:', error);
                    alert('Favorilere ekleme işlemi sırasında bir hata oluştu: ' + error.message);
                });
        }
    </script>
</asp:Content>
